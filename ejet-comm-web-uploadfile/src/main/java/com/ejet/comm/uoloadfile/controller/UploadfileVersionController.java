 ...
 */
@RestController()
@RequestMapping("/comm-web-uploadfile")
public class UploadfileVersionController extends ControllerBase {
    private final Logger log = LoggerFactory.getLogger(UploadfileVersionController.class);
    @ResponseBody
    ...
    public Result getVersion(@RequestBody(required=false) Param param, BindingResult bindResult) {
        ...
        try{
            ...
            version.setModuleName("springboot(ejet-comm-web-uploadfile)模块");
            version.setModuleVersion("v1.0.1 release");
            version.setLastModifyTime("2018-11-09 18:00:00");
