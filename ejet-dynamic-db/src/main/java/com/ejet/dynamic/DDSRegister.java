...
/**
 * 动态数据源注册
 * 启动动态数据源请在启动类中 添加 @Import(DDSRegister.class)
 */
public class DDSRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private static final Object DS_TYPE_DEFAULT = "com.alibaba.druid.pool.DruidDataSource";
    ...
    @Bean(name = "default-dds")
    @ConfigurationProperties(prefix = "spring.datasource.default-dds")
...
//        String dsPrefixs = env.getProperty(DB_NAME);
//        for (String dsPrefix : dsPrefixs.split(",")) {// 多个数据源
//            Map<String, Object> dsMap = env.get
...
//    }
    ...
    public DataSource buildDataSource(Map<String, Object> dsMap) {
        try {
            ...
            if (type == null)
                type = DS_TYPE_DEFAULT;// 默认DataSource
