...
import com.khsh.datac.patientview.vo.PatientVisitResultVO;
...
public class TestJson {
    ...
    public static void main(String[] args) {
        ...
        PatientVisitResultVO respVO = new PatientVisitResultVO();

        PatientVO patientVO = new PatientVO();
        patientVO.setEmpi("42203707-3-c9004387d2614ae98c144c947c9f80f5100010");
        patientVO.setName("王曾英");
        patientVO.setAge(36);
        patientVO.setBirthday("1982/06/22");
        patientVO.setIdCard("422822198206224025");
        patientVO.setJobName("");
        patientVO.setNationName("汉族");
        patientVO.setMarriageStateName("其他");
        patientVO.setAddrDetail("花坪蔡家村8组");

        respVO.setPatient(patientVO);

        List<PatientVisitVO> list = new ArrayList<>();
        ...
        list.add(vo);
        respVO.setVisitList(list);

        System.out.println(new Gson().toJson(respVO));
